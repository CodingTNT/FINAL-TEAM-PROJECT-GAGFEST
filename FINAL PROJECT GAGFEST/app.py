...
items = [
    ...
    {"script": "4Let's Draw Together.py", "title": "Let's Draw Together", "image": "game4.jpg"},
    {"script": "5Magic Bubble.py", "title": "Magic Bubble", "image": "game5.jpg"},
    {"script": "6Puzzle Game.py", "title": "Puzzle Game", "image": "game6.jpg"},
    {"script": "7Bury Me with Money.py", "title": "Bury Me with Money", "image": "game7.jpg"},
    {"script": "8Make a Cloth Tiger.py", "title": "Make a Cloth Tiger", "image": "game8.jpg"},
    {"script": "9Russian Roulette.py", "title": "Russian Roulette", "image": "game9.png"},
    {"script": None, "title": "AI Media Reviewer", "image": "game10.png", "url": "/reviewer"},
    {"script": None, "title": "Praise and Roast AI", "image": "game11.png", "url": "http://localhost:8501"},
    {"script": "12Deal with it.py", "title": "Deal With It", "image": "game12.jpg"},
]
...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* 背景图设置 */
            background-image: url('{{ url_for('serve_image', filename='gagfest.png') }}'); 
            ...
            <head>
                ...
                <style>
                    body {
                        ...
                        background: url('{{ url_for('serve_image', filename="game10.png") }}') no-repeat top center;
                        background-size: cover;
                        color: white;
                        margin: 0;
                        padding: 0;
