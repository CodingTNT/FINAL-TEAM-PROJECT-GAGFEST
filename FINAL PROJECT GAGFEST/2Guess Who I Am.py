...
assets = [
    {"image": os.path.join(base_path, "cleaner.png"), "rain_image": os.path.join(base_path, "cleaner1.png"), "text": "GUESS WHO I AM"},
    {"image": os.path.join(base_path, "farmer.png"), "rain_image": os.path.join(base_path, "farmer1.png"), "text": "GUESS WHO I AM"},
    {"image": os.path.join(base_path, "cook.png"), "rain_image": os.path.join(base_path, "cook2.png"), "text": "GUESS WHO I AM"},
    {"image": os.path.join(base_path, "worker.png"), "rain_image": os.path.join(base_path, "worker2.png"), "text": "GUESS WHO I AM"},
]
click_sound_path = os.path.join(base_path, 'cartoon_pop.flac')
